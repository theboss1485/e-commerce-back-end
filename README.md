...
My motivation for building this project was to gain experience with writing server routes using the JavaScript Sequelize package.  I built this project so that I could learn about Sequelize and how to use it effectively.  For this project, I was given starter code and I added elements such as modules and most of the routes.  This project is the back end code for what appears to be a hypothetical storefront.  I am taking a guess because I don't have front end code for this project.  The project solves the problem of a company with a storefront needing an effective back end so that the employees can retrieve data about their products, post new data, and update and delete existing data.  For this project, I learned about creating server routes with Javascript.  I also learned about creating models with Sequelize.
...
I realized after I made the walkthrough video that the text in Insomnia on the video is pretty small on laptop screens.  In the walkthrough video, I used the default text size both Git Bash and Insomnia.  I can still read the text in Insomnia on the laptop screen I am using.  I used the default text size in Git Bash for my other walkthrough videos and I haven't had any comments about it so far.  I have included the Walkthrough Video Explanation section to help you know what is going on in the walkthrough video.  If the text size is still a problem, let me know and I can redo the video. 
...
From here, open Insomnia and start creating routes.  Here is a demonstration screenshot on running the GET route localhost:3001/api/categories/: ![A successful run of the GET categories route](./assets/images/insomnia-get-categories-route.JPG)

This README won't be a tutorial on how to use Insomnia, so I will assume you know how to create new routes.  I will just tell you which routes to create.  You should create the following routes:
...
3. &nbsp;&nbsp;POST: &nbsp;localhost:3001/api/categories/
    ...
    &nbsp;&nbsp;This route creates a new category with a name of "Movies".
...
4. &nbsp;&nbsp;PUT: &nbsp;localhost:3001/api/categories/3
    ...
    &nbsp;&nbsp;This route updates the category with the ID of 3 to have a name of "Trouser".
...
3. &nbsp;&nbsp;POST: &nbsp;localhost:3001/api/products/
    ...
    &nbsp;&nbsp;JSON body: &nbsp;{"product_name": "Basketball", "price": "200.00","stock": 10, "tagIds": [1, 2, 3, 4]}

    &nbsp;&nbsp;This route creates a new product with a name of "Basketball", a price of 200.00 a stock of 10, and tag IDs of 1, 2, 3, and 4.
...
4. &nbsp;&nbsp;UPDATE: &nbsp;localhost:3001/api/products/4
    ...
    &nbsp;&nbsp;This route updates the product with the ID of 4 to now have a name of "Basket", a price of 250.00, and a stock of 4.

    &nbsp;&nbsp;The following return value indicates the update was successful: &nbsp;[1]

5. &nbsp;&nbsp;DELETE: &nbsp;localhost:3001/api/products/4

    &nbsp;&nbsp;This route deletes the product with the ID of 4.
...
1. &nbsp;&nbsp;GET: &nbsp;localhost:3001/api/tags/
    ...
    &nbsp;&nbsp;Successful Return: All tags and their associated product data and ProductTag data, which is data from the table connecting the Products table and the Tags table.

2. &nbsp;&nbsp;GET: &nbsp;localhost:3001/api/tags/1

    &nbsp;&nbsp;Successful Return: The tag with the ID of 1 and its associated product data and ProductTag data

3. &nbsp;&nbsp;POST: &nbsp;localhost:3001/api/tags/

    &nbsp;&nbsp;JSON body: &nbsp;{"tag_name":"Movies"}

    &nbsp;&nbsp;This route creates a new tag with a name of "Movies".
...
4. &nbsp;&nbsp;PUT: &nbsp;localhost:3001/api/tags/1
    ...
    &nbsp;&nbsp;This route updates the tag with the ID of 1 to have a name of "Unicorns".
...
Please note that I left out return characters in the JSON request bodies and the successful responses from the update requests.  You can see what the requests and responses look like with the return characters in the walkthrough video.
